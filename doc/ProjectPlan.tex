...
\section{Task Schedule}
  ...
  \begin{center}
    ...
    \begin{tabular}{| l || c | c | c | }
      ...
      \hline
        ...
        Store Raw User Data (User, Name, Followers, Friends) into Database (User Table) & Tien & 2012-1-21 & 2012-1-29 \\
	    Analyze Parsed Data for Influence & Tien & 2012-1-29 & 2012-2-19 \\
  ...
  \begin{center}
		{\bf Query Database: 7 weeks}
    \begin{tabular}{| l || c | c | c | }
      \hline
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Accept Filter from Interface & Jon & 2012-1-16 & 2012-1-20 \\
	    Sanitize Search Keyword & Jon & 2012-1-23 & 2012-1-27 \\
	    Build SQL Query from Filter & Jon & 2012-1-30 & 2012-2-3 \\
        Normalize Query Results & Jon & 2012-2-6 & 2012-2-17 \\
  ...
  \begin{center}
		{\bf Optional/Miscellaneous: 1 week}
    \begin{tabular}{| l || c | c | c | }
      \hline
      Task Description & Assignee & Start Date & Due Date \\
      \hline
