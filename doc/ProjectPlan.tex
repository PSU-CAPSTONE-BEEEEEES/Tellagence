...
\section{Role Descriptions}
  ...
  \subsection{Tien Le}
  {\bf System Administrator Lead:} Keep all of the computers running 24/7, software installation and configuration, backup cron job, write PHPUnit test. 
...
\begin{itemize}
    ...
    environment.
	\item {\bf PHPUnit}: This tool is designed to help create unit tests for
    PHP.
