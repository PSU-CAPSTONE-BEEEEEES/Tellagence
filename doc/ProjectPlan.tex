...
\section{Overview}
  ...
  \subsection{Requirements}
	...
	\begin{itemize}
		...
		\item We need to be able to parse multiple '@' mentions out of a single tweet, and distinguish between '@' & 'RT @'
...
\section{Role Descriptions}
  ...
  \subsection{Tien Le}
  {\bf System Administrator Lead:} Keep all of the computers running 24/7, software installation & configuration, backup cron job, write PHPUnit test. 
...
The milestones sync diagram describes how we synchronize the 3 milestones together. Three work portions are allotted into the 8-week timeframe. They start and end at the same time no matter how the tasks in each are accomplished. Some tasks overlaps are allowed within their group, i.e. DB population and Data transmit are initiated at different time, but finish simultaneously. There exist some dependencies between tasks of different groups, i.e. Prototype features with random data in Rendering can only be processed if we already have the random data from Data handling. Tasks are orderly organized so that all 3 groups concurrently end up at a specific state after 2 predefined periods:
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      \hline
	    ...
	    Page Elements Passed to Javascript & Derek & 2012-1-15 & 2012-1-21 \\
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Reschedule Tasks/Features for Prototype & All & 2012-1-22 & 2012-1-28 \\
	    Revamp Page Layout & Derek & 2012-1-29 & 2012-2-1 \\
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Page Layout/Styles Compatibility & Derek & 2012-2-4 & 2012-2-14 \\
	    Search and Filtering Rules & Aren & 2012-2-5 & 2012-2-8 \\
	    Search Input Caught and Classified & Aren & 2012-2-8 & 2012-2-18 \\
		List Rendering Metrics for Display & Derek & 2011-2-15 & 2011-2-18 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      \hline
	    ...
	    Integrate Metrics to Display & Derek & 2012-2-19 & 2012-2-24 \\
	    Hook up Search to Data backend & Aren & 2012-2-25 & 2012-3-3 \\
	    Verification/Validation for Project & Derek & 2012-2-25 & 2012-3-3 \\
        Add Licensing to Source & Derek & 2012-3-1 & 2012-3-3 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      \hline
        ...
        Store user_id and username into Database (Users Table) & Tien & 2012-1-15 & 2012-1-21 \\
	    Analyze Parsed Data for Influence & Tien & 2012-1-21 & 2012-2-1 \\
        Store Calculated Influence into Database (Relationship Table) & Tien & 2012-2-2 & 2012-2-10 \\
		Write PHPUnit test and fix bugs & Tien & 2012-2-11 & 2012-2-19 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      \hline
	    ...
	    Send JSON to Renderer & Tien & 2012-2-20 & 2012-2-24 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
		Ensure user names exist in twitter database & Tien & 2012-2-24 & 2012-2-26 \\
	    Accept Filter from Interface & Jon & & \\
	    Sanitize Search Keyword & Tien & 2012-2-26 & 2012-3-3 \\
