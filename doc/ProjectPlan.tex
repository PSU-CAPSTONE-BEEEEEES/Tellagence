...
\begin{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{|p{8.3cm} || c | c | c | }
      ...
      \hline
	    ...
	    Finalize data format  & Huy & 2012-2-1 & 2012-2-5 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| p{8.3cm} || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Complete/improve feature  (zoom in/out)  & Long & 2012-2-5 & 2012-2-10 \\
	    Complete/improve feature  (arrange nodes)  & Long & 2012-2-10 & 2012-2-15 \\
	    Complete/improve feature  (filter/search)  & Long & 2012-2-15 & 2012-2-19 \\
	    Integrate arrange node feature with Interface & Huy &
            2012-2-1 & 2012-2-10 \\
            Showing graph with all nodes & Huy & 2012-2-13 & 2012-2-24 \\
