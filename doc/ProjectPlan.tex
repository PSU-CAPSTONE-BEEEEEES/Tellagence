...
\section{Task Schedule}
  ...
  \begin{center}
    ...
    \begin{tabular}{| l || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Parsing data from xls to multidimensional array \emph{tweet}[][] & Tien & 2012-1-15 & 2012-1-21 \\
	    Isolate and verify username from each tweet & Tien & 2012-1-22 & 2012-1-28 \\
	    Count influence of each \emph{real\_users} and import santizied data to DB & Tien & 2012-1-29 & 2012-2-4 \\
      \hline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    \begin{tabular}{| l || c | c | c | }
      ...
      Task Description & Assignee & Start Date & Due Date \\
      \hline
	    Santizied \emph{search} keyword & Tien & 2012-2-19 & 2012-2-25 \\
	    Handle DB query search & Tien & 2012-2-26 & 2012-3-3 \\
      \hline
    \end{tabular}
  \end{center}
