...
load("../jsmockito/src/jsmockito.js");
load("../jsmockito/src/function.js");
load("../jsmockito/src/verifiers.js");
load("../jsmockito/src/object.js");
...
// fake out jQuery, add methods to fake similar to .hide()
$ = JsMockito.mockFunction();
JsMockito.when($).call(JsHamcrest.Matchers.anything()).thenReturn(
    JsMockito.mock({
        hide : JsMockito.mockFunction(),
        ready: JsMockito.mockFunction()
    })
);
var document = JsMockito.mock({});

load("../../site/js/toolbar.js");
load("./toolbar/toolbar_tests.js");
